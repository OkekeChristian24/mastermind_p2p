...
const { CreateBank, ViewUserBank, ViewAllBank, UpdateBank, DeleteBank } = require("../controllers/localBankController");
...
router.get('/:id', ViewAllBank);
// View users details
router.get('/view/:id',ViewUserBank);
// Update Bank details
